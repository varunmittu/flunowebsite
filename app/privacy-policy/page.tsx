  ...
  return (
    <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-14">
      ...
      <div className="prose prose-sm max-w-none font-body text-fluno-ink/80 space-y-8">
        ...
        <section>
          <h2 className="font-display text-xl text-fluno-ink mb-3">2. Consent</h2>
        ...
        <section>
          <h2 className="font-display text-xl text-fluno-ink mb-3">3. Data We Collect</h2>
        ...
        <section>
          <h2 className="font-display text-xl text-fluno-ink mb-3">4. How We Use Your Data</h2>
          <ul className="list-disc pl-5 space-y-2">
        ...
        <section>
          <h2 className="font-display text-xl text-fluno-ink mb-3">5. Marketing, Advertising &amp; Commercial Use of Contact Data</h2>
          ...
          <p className="mt-3"><strong>Opting out:</strong> You may opt out of marketing communications and of the sharing of your contact data with third parties at any time — by using the unsubscribe link in any email, replying STOP to SMS/WhatsApp, disabling notifications in your browser, or writing to <a href="mailto:contact@myfluno.com" className="text-fluno-teal hover:underline">contact@myfluno.com</a> with the subject line &ldquo;Opt Out&rdquo;. Transactional communications relating to your orders will continue regardless of marketing preferences.</p>
        </section>
        ...
        <section>
          <h2 className="font-display text-xl text-fluno-ink mb-3">7. Cookies &amp; Tracking Technologies</h2>
        ...
        <section>
          <h2 className="font-display text-xl text-fluno-ink mb-3">8. Data Retention</h2>
        ...
        <section>
          <h2 className="font-display text-xl text-fluno-ink mb-3">9. Security</h2>
        ...
        <section>
          <h2 className="font-display text-xl text-fluno-ink mb-3">10. Your Rights (DPDP Act, 2023)</h2>
          <ul className="list-disc pl-5 space-y-2">
          ...
          <p className="mt-3">To exercise any of these rights, write to <a href="mailto:contact@myfluno.com" className="text-fluno-teal hover:underline">contact@myfluno.com</a>. We aim to respond within 30 days.</p>
        </section>

        <section>
          <h2 className="font-display text-xl text-fluno-ink mb-3">11. Children</h2>
        ...
        <section>
          <h2 className="font-display text-xl text-fluno-ink mb-3">12. Changes to This Policy</h2>
        ...
        <section>
          <h2 className="font-display text-xl text-fluno-ink mb-3">13. Grievance Officer &amp; Contact</h2>
          ...
          <strong>Email:</strong> <a href="mailto:contact@myfluno.com" className="text-fluno-teal hover:underline">contact@myfluno.com</a> (subject: &ldquo;Grievance&rdquo;)<br />
