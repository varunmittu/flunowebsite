...
export default function Accessibility() {
  return (
    <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-14">
      ...
      <h1 className="section-title mb-2">Accessibility Statement</h1>
      ...
      <div className="prose prose-sm max-w-none font-body text-fluno-ink/80 space-y-8">
        <section>
          <h2 className="font-display text-xl text-fluno-ink mb-3">Our Commitment</h2>
        ...
        <section>
          <h2 className="font-display text-xl text-fluno-ink mb-3">What We Do</h2>
        ...
        <section>
          <h2 className="font-display text-xl text-fluno-ink mb-3">Known Limitations</h2>
        ...
        <section>
          <h2 className="font-display text-xl text-fluno-ink mb-3">Feedback</h2>
          <p>If you experience any accessibility barriers on our site, please contact us:</p>
          <p><strong>Email:</strong> <a href="mailto:contact@myfluno.com" className="text-fluno-teal hover:underline">contact@myfluno.com</a><br />
