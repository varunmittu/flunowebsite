...
export default function ShippingPolicy() {
  return (
    <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-14">
      ...
      <h1 className="font-fig font-bold text-3xl md:text-4xl text-fig-navy leading-tight mb-2">Shipping &amp; Delivery Policy</h1>
      ...
      <div className="prose prose-sm max-w-none font-fig-body text-fig-navy/80 space-y-8">
        <section>
          <h2 className="font-fig font-bold text-xl text-fig-navy mb-3">1. Serviceability</h2>
        ...
        <section>
          <h2 className="font-fig font-bold text-xl text-fig-navy mb-3">2. Processing Time</h2>
        ...
        <section>
          <h2 className="font-fig font-bold text-xl text-fig-navy mb-3">3. Delivery Timelines (Estimates Only)</h2>
        ...
        <section>
          <h2 className="font-fig font-bold text-xl text-fig-navy mb-3">4. Shipping Charges</h2>
          <ul className="list-disc pl-5 space-y-2">
        ...
        <section>
          <h2 className="font-fig font-bold text-xl text-fig-navy mb-3">5. Address Accuracy</h2>
        ...
        <section>
          <h2 className="font-fig font-bold text-xl text-fig-navy mb-3">6. Delivery Confirmation, Title &amp; Risk</h2>
        ...
        <section>
          <h2 className="font-fig font-bold text-xl text-fig-navy mb-3">7. Order Tracking</h2>
        ...
        <section>
          <h2 className="font-fig font-bold text-xl text-fig-navy mb-3">8. Failed Delivery Attempts</h2>
        ...
        <section>
          <h2 className="font-fig font-bold text-xl text-fig-navy mb-3">9. Lost or Stuck Shipments</h2>
        ...
        <section>
          <h2 className="font-fig font-bold text-xl text-fig-navy mb-3">10. Contact</h2>
          <p>For shipping queries, email <a href="mailto:contact@myfluno.com" className="text-fig-terracotta hover:underline">contact@myfluno.com</a> with your order ID, or raise a ticket at <a href="/support" className="text-fig-terracotta hover:underline">myfluno.com/support</a>.</p>
        </section>
      </div>
    </div>
  );
