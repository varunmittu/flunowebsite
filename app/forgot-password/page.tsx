        ...
        <div className="rounded-3xl border border-white/[0.08] p-8 sm:p-10" style={{ background: "rgba(255,255,255,0.03)", backdropFilter: "blur(20px)" }}>
          {sent ? (
            <div className="text-center py-4">
              ...
              <h1 className="font-display text-xl text-white font-semibold mb-2">Check your inbox</h1>
              ...
              <Link href="/login" className="font-mono text-xs text-fluno-purple hover:underline">
                Back to login
              </Link>
            </div>
          ) : (
            <>
              <div className="w-12 h-12 rounded-2xl bg-fluno-purple/15 border border-fluno-purple/25 flex items-center justify-center mb-5">
                <KeyRound size={20} className="text-fluno-purple" />
              </div>
              <h1 className="font-display text-xl text-white font-semibold mb-1.5">Forgot your password?</h1>
              ...
              <Link href="/login" className="flex items-center justify-center gap-1.5 font-mono text-xs text-white/30 hover:text-white/60 transition-colors mt-6">
