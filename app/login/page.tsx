...
import { ShieldCheck, ArrowRight, Sparkles, Loader2, Eye, EyeOff } from "lucide-react";
    ...
    <div className="min-h-screen flex items-center justify-center px-4 py-16 bg-fluno-dark relative overflow-hidden">
      ...
      >
        ...
        <div className="glass p-8">
          ...
          {/* Error */}
          {error && (
            <div className="mb-4 px-4 py-3 rounded-xl bg-red-500/10 border border-red-500/20 font-body text-sm text-red-400">
              {error}
            </div>
          )}
