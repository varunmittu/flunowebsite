...
export default function RefundPolicy() {
  return (
    <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-14">
      ...
      <h1 className="section-title mb-2">Return, Refund &amp; Cancellation Policy</h1>
      ...
      <div className="prose prose-sm max-w-none font-body text-fluno-ink/80 space-y-8">
        <section>
          <h2 className="font-display text-xl text-fluno-ink mb-3">1. Hygiene &amp; Personal Care Exclusion</h2>
        ...
        <section>
          <h2 className="font-display text-xl text-fluno-ink mb-3">2. Eligible Returns</h2>
        ...
        <section>
          <h2 className="font-display text-xl text-fluno-ink mb-3">4. Refunds</h2>
          <ul className="list-disc pl-5 space-y-2">
        ...
        <section>
          <h2 className="font-display text-xl text-fluno-ink mb-3">5. Exchanges</h2>
        ...
        <section>
          <h2 className="font-display text-xl text-fluno-ink mb-3">6. Cancellations</h2>
          <ul className="list-disc pl-5 space-y-2">
        ...
        <section>
          <h2 className="font-display text-xl text-fluno-ink mb-3">7. Abuse of Policy</h2>
        ...
        <section>
          <h2 className="font-display text-xl text-fluno-ink mb-3">8. Chargebacks</h2>
        ...
        <section>
          <h2 className="font-display text-xl text-fluno-ink mb-3">9. Contact</h2>
          <p><a href="mailto:contact@myfluno.com" className="text-fluno-teal hover:underline">contact@myfluno.com</a> · <a href="/support" className="text-fluno-teal hover:underline">myfluno.com/support</a> · Parvar Enterprises, India</p>
        </section>
      </div>
    </div>
  );
