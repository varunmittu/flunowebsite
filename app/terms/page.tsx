  ...
  return (
    <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-14">
      ...
      <div className="prose prose-sm max-w-none font-body text-fluno-ink/80 space-y-8">
        <section>
          <h2 className="font-display text-xl text-fluno-ink mb-3">1. Agreement &amp; Eligibility</h2>
        ...
        <section>
          <h2 className="font-display text-xl text-fluno-ink mb-3">2. Account &amp; Registration</h2>
        ...
        <section>
          <h2 className="font-display text-xl text-fluno-ink mb-3">3. Consent to Communications &amp; Data Use</h2>
          <p>By registering on the Platform or providing your email address or phone number, you expressly consent to receive transactional, promotional, and advertising communications from us and our partners via email, SMS, WhatsApp, RCS, phone call, and browser push notification — including where your numbers are registered on DND/NCPR — and you consent to the collection, use, sharing, and commercial disclosure of your contact data as described in our <a href="/privacy-policy" className="text-fluno-teal hover:underline">Privacy Policy</a>, which forms an integral part of these Terms. You may opt out of marketing at any time as described therein.</p>
        </section>

        <section>
          <h2 className="font-display text-xl text-fluno-ink mb-3">4. Products, Pricing &amp; Availability</h2>
          <ul className="list-disc pl-5 space-y-2">
        ...
        <section>
          <h2 className="font-display text-xl text-fluno-ink mb-3">5. Orders &amp; Payment</h2>
          <ul className="list-disc pl-5 space-y-2">
        ...
        <section>
          <h2 className="font-display text-xl text-fluno-ink mb-3">6. Product Use &amp; Safety Disclaimer</h2>
          <ul className="list-disc pl-5 space-y-2">
        ...
        <section>
          <h2 className="font-display text-xl text-fluno-ink mb-3">7. User Content &amp; Reviews</h2>
        ...
        <section>
          <h2 className="font-display text-xl text-fluno-ink mb-3">8. Intellectual Property</h2>
        ...
        <section>
          <h2 className="font-display text-xl text-fluno-ink mb-3">9. Prohibited Conduct</h2>
          <ul className="list-disc pl-5 space-y-2">
        ...
        <section>
          <h2 className="font-display text-xl text-fluno-ink mb-3">10. Disclaimer &amp; Limitation of Liability</h2>
        ...
        <section>
          <h2 className="font-display text-xl text-fluno-ink mb-3">11. Indemnification</h2>
        ...
        <section>
          <h2 className="font-display text-xl text-fluno-ink mb-3">12. Force Majeure</h2>
        ...
        <section>
          <h2 className="font-display text-xl text-fluno-ink mb-3">13. Governing Law &amp; Dispute Resolution</h2>
        ...
        <section>
          <h2 className="font-display text-xl text-fluno-ink mb-3">14. General</h2>
        ...
        <section>
          <h2 className="font-display text-xl text-fluno-ink mb-3">15. Contact</h2>
